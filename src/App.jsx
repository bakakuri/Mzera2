...
function Messages({ convos, openId, setOpenId, onSend, onReply, onCreateConvo, onOpenProfile, live, onMenu, groups, onOpenGroup }) {
  ...
  if (cv) {
    ...
    return (
      <div className="fixed inset-0 z-50 flex justify-center" style={{ background: C.paper }}>
  ...
  return (
    <div className="pb-28 md:pb-8">
      <div className="flex items-center gap-2 px-3 py-3 shrink-0" style={{ background: C.surface, borderBottom: `1px solid ${C.lineSoft}`, paddingTop: "max(0.75rem, env(safe-area-inset-top))" }}>
