...
export default function App() {
  ...
  const homeVisible = visible.filter(p => p.authorId === ME || following.includes(p.authorId) || p.publicStatus === "approved");
