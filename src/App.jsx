          ...
          <div className={fullBleed ? "" : "slidein"} key={tab + (profileId || "") + (feed.activeTag || "")}>
            {tab === "home" && (
              <>
                ...
                <NavStrip nav={NAV} onNav={goTab} onCreate={() => setCreateOpen(true)} flash={flash} tab={tab} xp={xp} onSettings={() => setSettingsOpen(true)} onSignOut={() => authApi.signOut().catch(dbErr("გასვლა"))} />
