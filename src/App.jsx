...
function Profile({ userId, posts, savedPosts, reels, xp, meProfile, following, followerCounts, onToggleFollow, onMessage, onOpenList, onSettings, flash, onBack, onTag, onLike, onReact, onSave, onComment, onPollVote, onReport, onRemove, onOpenProfile, isAdmin, onUploadAvatar, onUploadCover, onOpenReels, onAddReel, onReelDelete, onReelEdit }) {
  ...
  return (
    <div className="pb-28 md:pb-10">
      ...
      {editReel && (
        <div className="fixed inset-0 z-[60] flex items-end md:items-center justify-center" style={{ background: "rgba(0,0,0,.5)" }} onClick={() => setEditReel(null)}>
          <div className="w-full max-w-[440px] rounded-t-3xl md:rounded-3xl p-5" style={{ background: C.surface }} onClick={e => e.stopPropagation()}>
