...
export function Admin({ reports, posts, allUsers, userCount, postCount, online, onResolve, onRemovePost, onSetVerified, onSetAdmin, onOpenProfile, onBanUser, onGrantXp, listings, threads, reels, onDeleteListing, onDeleteThread, onDeleteReel }) {
  const [seg, setSeg] = useState("reports"); const [q, setQ] = useState(""); const [cseg, setCseg] = useState("listings"); const [confirm, setConfirm] = useState(null);
...
export function SettingsView({ settings, setSettings, meProfile, setMeProfile, mode, setMode, onClose, flash, onSignOut, onUploadAvatar }) {
...
export function SearchView({ posts, onOpenProfile, onTag, onClose }) {
