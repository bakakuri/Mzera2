...
export function Admin({ reports, posts, allUsers, userCount, postCount, online, stats, onResolve, onRemovePost, onSetVerified, onSetAdmin, onOpenProfile, onBanUser, onGrantXp, onSetXp, onDeleteUser, onBroadcast, listings, threads, reels, onDeleteListing, onDeleteThread, onDeleteReel }) {
