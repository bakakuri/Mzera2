...
export function notifVerb(type) {
  const map = { like: "notif.liked", comment: "notif.commented", reply: "notif.replied", follow: "notif.followed", mention: "notif.tagged", thread_reply: "notif.threadReplied", thread_activity: "notif.threadActivity", profile_view: "notif.profileViewed", reel_like: "notif.reelLiked", reel_comment: "notif.reelCommented", story_like: "notif.storyLiked", story_comment: "notif.storyCommented", post_tag: "notif.postTagged", group_post: "notif.groupPost", group_approved: "notif.groupApproved", event_rsvp: "notif.eventRsvp", birthday: "notif.birthday", level_up: "notif.levelUp", group_join_request: "notif.groupJoinRequest", comment_like: "notif.commentLiked", market_review: "notif.marketReview", announcement: "notif.announcement", public_approved: "notif.publicApproved", public_rejected: "notif.publicRejected" };
