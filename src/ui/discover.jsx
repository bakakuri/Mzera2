...
export function Forum({ threads, onReply, onVote, onNew, onOpenProfile }) {
...
export function Market({ listings, onSave, onNew, onMessage, onOpenProfile, flash, live, onOrder, getReviews, onAddReview, onUpload }) {
...
export function Groups({ groups, events, onJoin, onRsvp, onOpenProfile, onMessage, live, onGroupPost, onUpload, onCreateGroup, onCreateEvent, pendingOpen, clearPending }) {
