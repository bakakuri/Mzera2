...
export function Notifications({ notifs, onOpenProfile, onOpenPost, onOpenForum, onOpenReels, onOpenOwnStory, onOpenGroup, onOpenEvent, isFollowing, onToggleFollow }) {
  ...
  const verb = { like: t("notif.likedShort"), comment: t("notif.commentedShort"), reply: t("notif.repliedShort"), follow: t("notif.followedShort"), mention: t("notif.tagged"), thread_reply: t("notif.threadRepliedShort"), thread_activity: t("notif.threadActivityShort"), profile_view: t("notif.profileViewedShort"), reel_like: t("notif.reelLikedShort"), reel_comment: t("notif.reelCommentedShort"), story_like: t("notif.storyLikedShort"), story_comment: t("notif.storyCommentedShort"), post_tag: t("notif.postTaggedShort"), group_post: t("notif.groupPostShort"), group_approved: t("notif.groupApprovedShort"), event_rsvp: t("notif.eventRsvpShort"), birthday: t("notif.birthdayShort"), level_up: t("notif.levelUpShort"), group_join_request: t("notif.groupJoinRequestShort"), comment_like: t("notif.commentLikedShort"), market_review: t("notif.marketReviewShort"), repost: t("notif.repostShort"), poll_vote: t("notif.pollVoteShort"), announcement: t("notif.announcement"), public_approved: t("notif.publicApproved"), public_rejected: t("notif.publicRejected"), new_user_pending: t("notif.newUserPendingShort") };
  const Icon = { like: Heart, comment: MessageCircle, reply: Reply, follow: User, mention: Hash, thread_reply: MessageSquare, thread_activity: MessageSquare, profile_view: Eye, reel_like: Heart, reel_comment: MessageCircle, story_like: Heart, story_comment: MessageCircle, post_tag: Tag, group_post: Users, group_approved: Users, event_rsvp: Calendar, birthday: Gift, level_up: Trophy, group_join_request: Users, comment_like: Heart, market_review: ShoppingBag, repost: CornerUpLeft, poll_vote: Check, announcement: Bell, public_approved: Check, public_rejected: X, new_user_pending: UserPlus };
  const col = { like: C.like, comment: C.accent, reply: C.accent, follow: C.online, mention: C.star, thread_reply: C.accent, thread_activity: C.online, profile_view: C.cyan, reel_like: C.like, reel_comment: C.accent, story_like: C.like, story_comment: C.accent, post_tag: C.star, group_post: C.accent, group_approved: C.online, event_rsvp: C.accent, birthday: C.star, level_up: C.star, group_join_request: C.accent, comment_like: C.like, market_review: C.accent, repost: C.accent, poll_vote: C.online, announcement: C.accent, public_approved: C.online, public_rejected: C.like, new_user_pending: C.accent };
