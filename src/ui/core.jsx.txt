...
export function ReelCard({ r, onLike, onSave, onOpenProfile, flash, onComments, muted, onToggleMute, onView, priority = true }) {
    ...
    <div ref={rootRef} className="relative w-full" style={{ height: "100dvh", scrollSnapAlign: "start" }}>
      ...
      <div className="absolute left-3 right-16 text-white" style={{ bottom: 100 }}>
        ...
        <div className="flex items-center gap-3 text-[12px]" style={{ opacity: 0.92 }}>
          <span className="flex items-center gap-1.5"><span style={{ fontSize: 13 }}>♪</span><span className="truncate" style={{ maxWidth: 150 }}>{r.audio}</span></span>
