...
export function useAuthSession({ flash, reloadFeed }) {
  ...
  const [settings, setSettings] = useState(() => lsGet("mz_settings", { activity: true, nLikes: true, nComments: true, nFollows: true, nMessages: true, nMentions: true, nProfileViews: true, lang: LANG }));
