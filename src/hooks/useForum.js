...
export function useForum({ session, flash, dbErr, setDbError }) {
  ...
  return { threads, loadThreads, onThreadReply, onThreadVote, onReplyVote, onSetThreadPinned, onSetThreadLocked, onNewThread, onEditThread, onDeleteThread, pendingThread, setPendingThread, pendingThreadReplyId, setPendingThreadReplyId };
}
